...
<header class="masthead text-white"> {{-- masthead  --}}
    ...
    <div class="bg-dark w-100">
		<div class="container py-4">
			<h1 class="font-24 font-weight-bold font-lato text-white mb-0 py-3">My Orders</h1>
		</div>
    </div>
</header>

<div class="container pb-5 font-lato">
	{{ Form::open(['route' => ['buyer_orders'], 'method' => 'GET', 'id'=>'status_form_Search', 'name' => 'status_search','class' => 'sticky-filter-header']) }}
    ...
    <div class="row mt-4">
        <div class="col-12 col-md-5 pl-md-0 d-md-flex">
			...
			<div class="mt-3 mt-md-0 col-md-8 px-0">
				{{ Form::text('search',isset($_GET['search'])?$_GET['search']:'',['class'=>'form-control font-14 text-color-4 summary', 'id'=>'search', 'placeholder'=>'Service or Seller/Author Name', 'autocomplete'=>'off']) }}
			</div>
        </div>
        ...
        <div class="col-12 col-md-2 pl-md-0 mt-3 mt-md-0">
			{{Form::select('ordertype', ['course' => 'Course','service' => 'Service','recursive'=>'Recurring', 'customorder' => 'Custom Order', 'job' => 'Job'], isset($_GET['ordertype'])?$_GET['ordertype']:'',['class'=>'form-control select_pr', 'id'=>'ordertype','placeholder'=>'Order Type'])}}
		</div>
	...
	<div class="row mt-2 justify-content-end">
		...
		<div class="col-12 col-md-1 pl-md-0 d-flex align-items-center mt-3 mt-xl-0">
			<a href="{{route('buyer_orders')}}" class="font-14 font-weight-bold text-color-1">Clear Filters</a>
        </div>
	</div>
	{{ Form::close() }}						
