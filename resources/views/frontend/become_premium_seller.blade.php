...
@section('pageTitle', 'demo - Become A Premium Seller')
@section('content')
	...
	<div class="profile-sec">
		<div class="cus-container container">
			<div class="row cus-filter align-items-center">
				<h2 class="heading">Become A Premium Seller</h2>
			</div>
		</div>
			...
			<div class="row second-row align-items-center">          
				<div class="col-lg-8">
					<div class="profile-desc bcmseller">
						<h4>Ready to take your demo account to the next level?</h4>
						<h5 class="mt-2">Upgrade your seller account to premium and unlock these awesome exclusive benefits...</h5>
		...
		<div class="process-pay bcmseller">  
			...
			@if($newUserSub == 1)
				<a href="{{route('show_premium_payment')}}" role="button"><button type="button" class="pro-btn">Unlock my subscription <span style="font-size:15px;">( ${{number_format($subscription->price,2)}} / Month )</span></button></a>
			@else
				<a href="{{route('show_premium_payment')}}" role="button"><button type="button" class="pro-btn">Upgrade subscription <span style="font-size:15px;">( ${{number_format($subscription->price,2)}} / Month )</span></button></a>
			@endif
			@else
